      ...
      <View style={{ overflow: 'hidden' }} >
        <TouchableNativeFeedback onPress={this.onPressPicker} >
          <View style={{ width: '100%', height: '100%', flexDirection: 'row' }} >
            <View style={{ width: '75%', height: '100%', justifyContent: 'center', paddingHorizontal: 10 }} >
              <Text text={this.props.item} style={{ fontSize: 18, fontFamily: 'Roboto-Light', textAlign: 'left' }} />
            </View>
        ...
        >
          <View style={{ maxHeight: 300 }} >
            <Text text={this.props.title ? this.props.title : 'Select'} type='h4' style={{ color: '#000' }} />
            <ScrollView>
